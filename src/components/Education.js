    ...
    <div className="my-64">
      ...
      <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
          <Details
            type={"Honours Bachelor of Science"}
            time={"2022-2026"}
          ...
          <Details
            ...
            time={"2020-Present"}
            place={"Coursera, EdX, Udemy"}
            info={
              "Relevant courses: Complete Web Development Bootcamp, Andrew Ng Machine Learning Specialization, Data Structures + Algorithms"
            }
          />
        </ul>
      </div>
